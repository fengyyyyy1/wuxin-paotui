...
public enum ResultCode {
    ...
    RIDER_ALREADY_APPLIED(409, "当前用户已提交骑手申请"),
    RIDER_AUDIT_STATUS_ERROR(409, "当前骑手审核状态不可操作"),
    RIDER_STATUS_ERROR(409, "当前骑手状态不可操作"),
    ...
    ADMIN_FORBIDDEN(403, "无管理员权限"),
    ADMIN_MERCHANT_NOT_EXIST(404, "商家不存在"),
    MERCHANT_AUDIT_STATUS_ERROR(409, "当前商家审核状态不可操作"),
    MERCHANT_STATUS_ERROR(409, "当前商家状态不可操作"),
