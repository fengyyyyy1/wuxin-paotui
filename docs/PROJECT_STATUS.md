...
项目状态：V1.8 骑手端与商家端代码完成。骑手申请数据库增量脚本尚待人工执行，双端尚待微信开发者工具人工验收。

当前断点：V1.8 骑手端与商家端开发完成，下一步进入总控端订单、用户、骑手与运营数据管理。
...
- [x] Java 21后端41项自动化测试通过
- [x] 双端Build、Lint和TypeScript检查通过
- [ ] 人工执行`15_update_rider_application.sql`
- [ ] 骑手资料与我的配送接口迁移后复测
- [ ] 双端微信开发者工具人工验收和正式AppID配置
...
- 骑手线上申请暂无后端接口，页面仅展示真实申请边界，不伪造提交结果。
